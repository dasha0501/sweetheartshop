	...
	<form action="index.php" method="GET">
		...
		<div class="col-12 ban mb-0" style="">
			<div class="row">
				...
				<div class="col-2" >
					<div class="row">
						<img src="5.png" class="logo" style="margin-left: 1000px; height: 100px;">
					</div>	
				</div>			
			</div>
		</div>
		...
		<div style="height:800px; background: #f8e5de;">
			<img src="8.jpg" style="margin-left: 800px;">
			<h1 class="font font-color" style="margin-left: 870px;">MINI RAINBOW BUNDLE</h1>
			<h5 class="font font-color" style="margin-left: 800px;">A collection of bright and bold mini liquid lipsticks.Launched in collaboration with the Los Angeles LGBT Center, Jeffree Star’s Mini Rainbow Bundle features eight vibrant shades packaged in a travel-friendly rainbow box. Lightweight and long-lasting, these highly-pigmented lipsticks are ideal for adding a colourful finish to your look..</h5>
		</div>
		<!--список-->
		<div class="col-10 mx-auto">
			<?php 
		...
		<div class="bg2 col-10 mx-auto" style="margin-top:100px;">
			<div class="row">
				<div class="col-4 border-light border-right border-bottom" style="">
					<?php 
						echo "<h2 class='font3 text-center font-color' style='height: 60px;'>" . $stroka["title"] . "</h3>";
						echo "<p class='font text-center mt-2 font-color'style='height: 50px;'>". $stroka["dess"] . "</p>";
				...
				<div class="col-4 border-light border-right border-bottom" style="">
					<?php 
						...
						echo "<p class='font text-center mt-2 font-color'style='height: 50px;'>". $stroka2["dess"] . "</p>";
				...
				<div class="col-4 border-light border-bottom" style="">
					<?php 
						...
						echo "<p class='font text-center mt-2 font-color'style='height: 50px;'>". $stroka3["dess"] . "</p>";
			...
			<div class="row">
				...
				<div class="col-4 border-light border-right" style="">
					<?php 
						echo "<h3 class='font3 text-center font-color' style='height: 50px;'>" . $stroka8["title"] . "</h3>";
						echo "<p class='font text-center mt-2 font-color'style='height: 60px;'>". $stroka8["dess"] . "</p>";
						echo "<div class='col-10 mx-auto' style='margin-top: 80px;'> <img class='w-100' src='" .  $stroka8["img"] . "'> </div>";
						echo "<p class='font text-center mt-2 font-color' style='height: 30px;'>" . $stroka8["price"] . " </p>";
					?>
				</div>
